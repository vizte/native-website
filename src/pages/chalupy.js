...
let allImages = [
  document.querySelector(".popup-image1"),
  document.querySelector(".popup-image2"),
  document.querySelector(".popup-image3"),
  document.querySelector(".popup-image4"),
  document.querySelector(".popup-image5"),
  document.querySelector(".popup-image6"),
  document.querySelector(".popup-image7"),
  document.querySelector(".popup-image8"),
  document.querySelector(".popup-image9"),
  document.querySelector(".popup-image10"),
  document.querySelector(".popup-image11"),
  document.querySelector(".popup-image12"),
  document.querySelector(".popup-image13"),
  document.querySelector(".popup-image14"),
  document.querySelector(".popup-image15"),
  document.querySelector(".popup-image16"),
  document.querySelector(".popup-image17"),
  document.querySelector(".popup-image18"),
  document.querySelector(".popup-image19"),
  document.querySelector(".popup-image20"),
  document.querySelector(".popup-image21"),
  document.querySelector(".popup-image22"),
  document.querySelector(".popup-image23"),
  document.querySelector(".popup-image24"),
  document.querySelector(".popup-image25"),
  document.querySelector(".popup-image26"),
  document.querySelector(".popup-image27"),
  document.querySelector(".popup-image28"),
  document.querySelector(".popup-image29"),
  document.querySelector(".popup-image30"),
  document.querySelector(".popup-image31"),
  document.querySelector(".popup-image32"),
  document.querySelector(".popup-image33"),
  document.querySelector(".popup-image34"),
  document.querySelector(".popup-image35"),
  document.querySelector(".popup-image36"),
  document.querySelector(".popup-image37"),
  document.querySelector(".popup-image38"),
  document.querySelector(".popup-image39"),
  document.querySelector(".popup-image40"),
  document.querySelector(".popup-image41"),
  document.querySelector(".popup-image42"),
  document.querySelector(".popup-image43"),
  document.querySelector(".popup-image44"),
  document.querySelector(".popup-image45"),
  document.querySelector(".popup-image46"),
  document.querySelector(".popup-image47"),
  document.querySelector(".popup-image48"),
  document.querySelector(".popup-image49"),
  document.querySelector(".popup-image50"),
  document.querySelector(".popup-image51"),
  document.querySelector(".popup-image52"),
];

/* set onClick event to all images */
...
/* Set popup hrefs */
document.querySelector("#popupAnicka").onclick = () => {
  window.location.href = "#containerAnicka";
};
document.querySelector("#popupMjolk").onclick = () => {
  window.location.href = "#containerMjolk";
};
document.querySelector("#popupUjezera").onclick = () => {
  window.location.href = "#containerpopupUjezera";
};
document.querySelector("#popupSumava").onclick = () => {
  window.location.href = "#containerSumava";
};
document.querySelector("#popupJizerky").onclick = () => {
  window.location.href = "#containerJizerky";
};
document.querySelector("#popupVranov").onclick = () => {
  window.location.href = "#containerVranov";
};
document.querySelector("#popupASlovensko").onclick = () => {
  window.location.href = "#containerASlovensko";
};
document.querySelector("#popupAQuebec").onclick = () => {
  window.location.href = "#containerAQuebec";
};
document.querySelector("#popupAKalifornie").onclick = () => {
  window.location.href = "#containerAKalifornie";
};
document.querySelector("#popupANolla").onclick = () => {
  window.location.href = "#containerANolla";
};
document.querySelector("#popupKvetLois").onclick = () => {
  window.location.href = "#containerKvetLois";
};
document.querySelector("#popupMiramari").onclick = () => {
  window.location.href = "#containerMiramari";
};
document.querySelector("#popupMobileHut").onclick = () => {
  window.location.href = "#containerMobileHut";
};
...
document.querySelector("#card5").onclick = () => {
  document.querySelector(".popup-image5").style.display = "block";
};
...
document.querySelector("#card9").onclick = () => {
  document.querySelector(".popup-image9").style.display = "block";
};
